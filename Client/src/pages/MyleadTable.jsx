...
//                       <div className="rounded-t-xl bg-blue-200 border-b-2 border-neutral-100 px-6 py-3 dark:border-neutral-600 dark:text-neutral-70">
...
//                         <button
//                           type="button"
//                           className="inline-block rounded bg-blue-300 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-black shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59..."
//                           onClick={() => Fetchpopdata(e._id, e.service.service_name)}
//                         >
//                           View
//                         </button>
//                         {view && (
                  ...
                  <div className="">
                    ...
                    <div className="grid grid-cols-2">
                      ...
                      <div className="">
                        ...
                        <p className="font-semibold"></p>
                        <p className="font-semibold"></p>
                        {/* <p className="font-semibold">{popupdata}</p> */}
                      </div>
                    </div>
                  </div>
                </div>
